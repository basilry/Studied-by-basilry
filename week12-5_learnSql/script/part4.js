...
*/
const PART4_3 = `insert into user (name, email) values ('basilry', 'basilry@gmail.com')`;
...
*/
const PART4_10 = `insert into content (title, body, userId) values ('let me go home', 'but i am home now..', '1')`;
