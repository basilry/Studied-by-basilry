...
const { User } = require("../__tests__/fixtures/model");
...
// ALTER TABLE content ADD COLUMN body varchar(255) after id;
// ALTER TABLE content ADD COLUMN title varchar(255) body;